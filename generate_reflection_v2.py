...
ctr("RWANDA POLYTECHNIC — RP HUYE COLLEGE", 13, True, TEAL)
...
lv("Institution",          "Rwanda Polytechnic — RP Huye College, Huye District, Rwanda")
