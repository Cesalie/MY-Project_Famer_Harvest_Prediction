      ...
      <section style={{
        ...
        <div style={{ maxWidth: 720, margin: "0 auto" }}>
          <div style={{
            ...
            <span>🌾</span> {lang === "en" ? "Bugesera District · Rwanda · ML-Powered Agriculture" : "Akarere ka Bugesera · Rwanda · Ubuhinzi bw'Ikoranabuhanga"}
          </div>
      ...
      <section style={{ padding: "72px 24px", background: "white" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 24 }}>
            {[
              {
                step: "01", icon: "🚜", color: "#ccfbf1", iconColor: "#0f766e",
              ...
              {
                step: "02", icon: "🌦️", color: "#ccfbf1", iconColor: "#0d9488",
