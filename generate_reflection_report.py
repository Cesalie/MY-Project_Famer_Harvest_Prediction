...
p.paragraph_format.space_after = Pt(4)
run = p.add_run("RWANDA POLYTECHNIC — RP HUYE COLLEGE")
...
for label, val in [
    ...
    ("Institution",    "Rwanda Polytechnic — RP Huye College"),
    ("Date",           "June 2026"),
]:
    p = doc.add_paragraph()
    p.alignment = WD_ALIGN_PARAGRAPH.CENTER
...
add_label_value(doc, "Institution", "Rwanda Polytechnic — RP Huye College")
...
add_para(doc, "I am highly confident that the Bugesera Harvest Prediction System meets all academic requirements set by Rwanda Polytechnic for the Bachelor of Technology in ICT Final Year Project. The system demonstrates:")
for c in [
